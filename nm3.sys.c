...
NDIS_STATUS __fastcall nmFilterDoInternalRequest(int Oid, FilterDeviceExtension *DeviceExtension, int RequestType_1, __int64 *Information, unsigned int InformationBufferLength, int a6, __int64 a7, unsigned int **a8);
...
NTSTATUS __fastcall NmCreateDot11Filter(NDIS_HANDLE NdisHandle, PNDIS_FILTER_ATTACH_PARAMETERS AttachParameter, _QWORD *a3);
...
NTSTATUS __fastcall NmCopyNetBufferToCaptureBuffer(__int64 a4, unsigned int edx0, void *a2, char *r9_0, unsigned int a3, void *a2a, void *a7, unsigned int a3a);
...
void __fastcall NetmonOidRequestComplete(FilterDeviceExtension *FilterModuleContext, PNDIS_OID_REQUEST OidRequest, NDIS_STATUS Status)
{
  ...
  if ( OidRequest_2 )
  {
    ...
    {
      OidRequest_2->DATA.QUERY_INFORMATION.BytesNeeded = OidRequest->DATA.QUERY_INFORMATION.BytesNeeded;
      v8 = FilterModuleContext->qword3B0;
...
NDIS_STATUS __fastcall nmOid_Query(int a1, FilterDeviceExtension *a2, __int64 *a3, unsigned int a4)
{
  ...
  unsigned int *a8; // [rsp+40h] [rbp-18h] BYREF
...
NDIS_STATUS __fastcall NmGetGlobalStat(FilterDeviceExtension *FilterDeviceExtension, int n, __int64 *a3, unsigned int a4)
{
  ...
  v6 = (unsigned int *)a3;
  LODWORD(v5) = 0;
  return nmFilterDoInternalRequest(n, FilterDeviceExtension, 0, a3, a4, 0, v5, &v6);
}
...
void __fastcall NmDerefCaptureBuffer(PVOID P)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)P + 22, 0xFFFFFFFF) == 1 )
  {
    ...
    _InterlockedExchange64((volatile __int64 *)(v3 + 104), 0i64);
    IoReleaseCancelSpinLock(*(_BYTE *)(v3 + 69));
    FsContext->irql = KeAcquireSpinLockRaiseToDpc(&FsContext->SpinLock);
    v4 = (_QWORD *)*((_QWORD *)P + 10);
    v5 = *((_QWORD *)P + 9);
    *v4 = v5;
    *(_QWORD *)(v5 + 8) = v4;
    v6 = (unsigned int)++*(_DWORD *)(*((_QWORD *)P + 8) + 104i64);
    KeReleaseSpinLock(&FsContext->SpinLock, FsContext->irql);
    v7 = *((_QWORD *)P + 8);
    memmove((char *)P + 176, (const void *)(v7 + 248), 0x30u);
    memmove((char *)P + 128, (const void *)(v7 + 200), 0x30u);
    *((_QWORD *)P + 23) = v6;
    NmDestroyCaptureBuffer(P);
...
void __fastcall NmDestroyCaptureBuffer(PVOID P)
{
  ...
  irp = (_IRP *)*((_QWORD *)P + 2);
  if ( irp->IoStatus.Status == (unsigned int)STATUS_CANCELLED || irp->IoStatus.Status == 0xC0000008 || irp->IoStatus.Status == NDIS_STATUS_RESOURCES )
  {
  ...
  else
  {
    ...
    *(_QWORD *)&v10[1] = 0i64;
    ...
    v10[0] = v5;
    memmove(Dst, (char *)P + 128, 0x30u);
    memmove(v12, (char *)P + 176, 0x30u);
    v6 = (const void *)(*((_QWORD *)P + 8) + 296i64);
    v14 = 192;
    memmove(v13, v6, 0x28u);
    *(_DWORD *)(*((_QWORD *)P + 2) + 48i64) = 0;
    *(_QWORD *)(*((_QWORD *)P + 2) + 56i64) = *((unsigned int *)P + 23);
    if ( v4 )
...
char __fastcall AddAceToAcl(ACL *acl, GroupAce *GroupAce)
{
  ...
  {
    v4 = acl + 1;
    for ( i = 0; i < acl->AceCount; v4 = (ACL *)((char *)v4 + v4->AclSize) )
    {
      if ( v4 >= (ACL *)((char *)acl + acl->AclSize) )
        break;
      ++i;
    }
    DataLength = (unsigned __int16)GroupAce->DataLength;
    if ( (char *)v4 + DataLength > (char *)acl + acl->AclSize )
    {
      ret = 0;
    }
    else
...
void __fastcall pNmDot11StoreOpMode(__int64 a1, int a2)
{
  ...
  if ( a1 )
  {
    ...
    *(_DWORD *)(a1 + 168) = a2;
    *(_BYTE *)(a1 + 136) = v4;
    KeReleaseSpinLock((PKSPIN_LOCK)(a1 + 128), v4);
  }
}
...
__int64 __fastcall pNmDot11QueryMonitorMode(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_DWORD *)(a1 + 168) == 0x80000000 )
      b = 1;
    *(_BYTE *)(a1 + 136) = NewIrql;
    KeReleaseSpinLock((PKSPIN_LOCK)(a1 + 128), NewIrql);
  }
  return b;
}
...
__int64 __fastcall pNmDot11QueryCurrentIfc(FilterDeviceExtension *DeviceExtension)
{
  ...
  unsigned int *a8; // [rsp+58h] [rbp+10h] BYREF

  v2 = DeviceExtension->qword3B0;
  if ( !v2 )
    return 0i64;
  *(_BYTE *)(DeviceExtension->qword3B0 + 136i64) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 128));
  ...
  {
    LODWORD(v8) = 0;
    status = nmFilterDoInternalRequest(0xE010192, DeviceExtension, 0, &a4, 4u, 0, v8, &a8);
    if ( status )
      DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_ERROR_LEVEL, "pNmDot11QueryCurrentIfc: status %x\n", status);
    else
      pNmDot11StoreCurrentIfc(DeviceExtension->qword3B0, a4);
    *(_BYTE *)(DeviceExtension->qword3B0 + 136i64) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(DeviceExtension->qword3B0 + 128i64));
    v7 = DeviceExtension->qword3B0;
    v5 = *(_QWORD *)(v7 + 176);
...
void __fastcall NmDeleteDot11Parameters(PVOID VirtualAddress)
{
  ...
  if ( VirtualAddress )
  {
    if ( *((_DWORD *)VirtualAddress + 41) )
    {
      ...
      while ( v1 < *((_DWORD *)VirtualAddress + 41) );
    }
    ...
    *((_DWORD *)v4 + 41) = v11;
    if ( v11 )
    {
      ...
      do
      {
        ...
        v16 = NdisAllocateMemoryWithTagPriority(NdisHandle, 0x468u, 't3mN', LowPoolPriority);// 又是个结构？
        if ( v16 )
        {
          *v13 = v16;
          v16[5] = v10;
...
NTSTATUS __fastcall NmDot11SetPhyId(FilterDeviceExtension *DeviceExtension, unsigned int a2)
{
  ...
  unsigned int *a8; // [rsp+60h] [rbp+8h] BYREF
  ...
  *(_OWORD *)a4 = 0ui64;
  ...
  a4[0] = 0x100100180i64;
  LODWORD(a4[1]) = 1;
  status_1 = nmFilterDoInternalRequest(OID_DOT11_DESIRED_PHY_LIST, DeviceExtension, 1, a4, 0x10u, 0, v8, &a8);
  if ( status_1 )
    DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_ERROR_LEVEL, "NmSetDot11PhyType: Attempted set DESIRED_PHY_LIST, status %x\n", status_1);
  LODWORD(v9) = 0;
  status = nmFilterDoInternalRequest(OID_DOT11_CURRENT_PHY_ID, DeviceExtension, 1, &Information, 4u, 0, v9, &a8);
  NtStatus = status;
  if ( status )
...
__int64 __fastcall NmDot11SetChannel(FilterDeviceExtension *DeviceExtension, unsigned int channel_1)
{
  ...
  unsigned int *a8; // [rsp+50h] [rbp+8h] BYREF
  ...
  {
    LODWORD(v10) = 0;
    Status = nmFilterDoInternalRequest(*(_DWORD *)(NtStatus + 1120), DeviceExtension, 1, &channel, 4u, 0, v10, &a8);
    v7 = Status;
    if ( Status )
    {
      LODWORD(v9) = Status;
...
NDIS_STATUS __fastcall NmSetPacketFilter(FilterDeviceExtension *ModuleContext, int filter)
{
  ...
  unsigned int *a8; // [rsp+60h] [rbp+18h] BYREF

  LODWORD(a4) = filter;
  LODWORD(v3) = 0;
  return nmFilterDoInternalRequest(OID_GEN_CURRENT_PACKET_FILTER, ModuleContext, 1, &a4, 4u, 0, v3, &a8);
}
...
__int64 __fastcall NmQueryPacketFilter(FilterDeviceExtension *ModuleContext, __int64 filter)
{
  ...
  LODWORD(v7) = 0;
  Status = nmFilterDoInternalRequest(OID_GEN_CURRENT_PACKET_FILTER, ModuleContext, 0, (__int64 *)filter, 4u, 0, v7, &a8);
  NtStatus = Status;
  if ( g_NmDebug )
  {
    LODWORD(InformationBufferLength) = Status;
    DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_ERROR_LEVEL, "NmQPacketFilter: Attempted to Q %x, status %x\n", *(unsigned int *)filter, InformationBufferLength);
  }
  return NtStatus;
}
...
_BOOL8 __fastcall NmSetAppropriatePacketFilter(FilterDeviceExtension *DeviceExtension, int a2)
{
  ...
  if ( b )
  {
    ...
    if ( !v6 )
      goto LABEL_11;
    if ( v7 || LOBYTE(DeviceExtension->gap224) )
    {
      filter = 32;
      goto LABEL_18;
    }
...
NTSTATUS __fastcall NmCreateFilterModule(NDIS_HANDLE NdisFilterHandle, PNDIS_FILTER_ATTACH_PARAMETERS AttachParameters, FilterDeviceExtension **DeferredContext)
{
  ...
  if ( BaseMiniportName )
  {
    ...
    v3 = v14;
    v27.m128i_i64[1] = (__int64)v14;
    if ( v14 )
    {
      v27.m128i_i16[1] = BaseMiniport.Length;
      memmove(v14, BaseMiniport.Buffer, BaseMiniport.Length);
      v27.m128i_i16[0] = BaseMiniport.Length;
    }
    else
    {
      NtStatus = NDIS_STATUS_RESOURCES;
...
LABEL_28:
  ...
  {
    NmCreateDot11Filter(NdisFilterHandle, AttachParameters, &a3);
    v8 = a3;
    if ( !a3 )
    {
      NtStatus = NDIS_STATUS_RESOURCES;
  ...
  if ( NtStatus >= 0 )
  {
    ...
    *(_WORD *)&DeviceExtension->char3D8 = Length_3;
    ...
    DeviceExtension->m128i110 = _mm_loadu_si128((const __m128i *)&DeviceName);
    ...
    DeviceExtension->m128i120 = v22;
    DeviceExtension->m128i130 = v23;
    NmAddGroupAccessAce(pDeviceObject);
    DeviceExtension->dword21C = 0;
    DeviceExtension->dword220 = 0;
    DeviceExtension->qword18 = &DeviceExtension->char10;
...
void __fastcall NmDestroyFilterModule(FilterDeviceExtension *DeviceExtension)
{
  ...
  v3 = DeviceExtension->char10;
  v4 = (__int64 *)DeviceExtension->qword18;
  *v4 = v3;
  *(_QWORD *)(v3 + 8) = v4;
  KeReleaseSpinLock(&g_FilterListLock, g_Irql);
  ExDeleteResourceLite(&DeviceExtension->eresource);
  IoDeleteSymbolicLink((PUNICODE_STRING)&DeviceExtension->m128i120);
  v5 = (void *)DeviceExtension->m128i130.m128i_i64[1];
  if ( v5 )
    NdisFreeMemory(v5, 0, 0);
  v6 = (void *)DeviceExtension->m128i110.m128i_i64[1];
  if ( v6 )
    NdisFreeMemory(v6, 0, 0);
  v7 = (void *)DeviceExtension->m128i120.m128i_i64[1];
  if ( v7 )
    NdisFreeMemory(v7, 0, 0);
  v8 = (void *)DeviceExtension->qword3B0;
  if ( v8 )
    NmDeleteDot11Parameters(v8);
...
void __fastcall StackModuleInstance(FilterDeviceExtension *FilterModuleContext, int b)
{
  ...
  if ( g_FilterModuleList.Flink != &g_FilterModuleList )
  {
    LOWORD(v9) = FilterModuleContext->m128i130.m128i_i16[0];
    do
    {
      if ( LOWORD(FilterModuleList[18].Flink) == (_WORD)v9 )
      {
        v9 = FilterModuleContext->m128i130.m128i_u16[0];
        if ( v9 == RtlCompareMemory(FilterModuleList[18].Blink, (const void *)FilterModuleContext->m128i130.m128i_i64[1], v9) )
        {
  ...
  if ( v4 )
  {
    ...
    FilterModuleContext->char10 = (__int64)g_FilterModuleList.Flink;
    FilterModuleContext->qword18 = &g_FilterModuleList;
    v16->Blink = (_LIST_ENTRY *)&FilterModuleContext->char10;
    g_FilterModuleList.Flink = (_LIST_ENTRY *)&FilterModuleContext->char10;
  }
  else if ( v6 )
  {
    ...
    FilterModuleContext->qword18 = &g_ByPassFilterModuleList;
    FilterModuleContext->char10 = (__int64)v17;
    v17->Blink = (_LIST_ENTRY *)&FilterModuleContext->char10;
    g_ByPassFilterModuleList.Flink = (_LIST_ENTRY *)&FilterModuleContext->char10;
  }
  else
  {
    if ( v5 )
    ...
    FilterModuleList_1 = g_FilterModuleList.Flink;
    FilterModuleContext->qword18 = &g_FilterModuleList;
    FilterModuleContext->char10 = (__int64)FilterModuleList_1;
    FilterModuleList_1->Blink = (_LIST_ENTRY *)&FilterModuleContext->char10;
    g_FilterModuleList.Flink = (_LIST_ENTRY *)&FilterModuleContext->char10;
  }
  Irql_2 = g_Irql;
LABEL_26:
...
NTSTATUS __fastcall NmFilterModuleIoControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  unsigned int *a8; // [rsp+40h] [rbp-58h] BYREF
...
LABEL_19:
        ...
        LODWORD(a7) = 0;
        status = nmFilterDoInternalRequest(OID_DOT11_CURRENT_PHY_ID, DeviceExtension, 0, &a4, 4u, 0, a7, &a8);
        Status = status;
        if ( status )
      ...
      else
      {
        ...
        if ( v21 )
        {
          oid = *(_DWORD *)(v21 + 1120);
          LODWORD(a7) = 0;
          v23 = nmFilterDoInternalRequest(oid, DeviceExtension, 0, &Information, 4u, 0, a7, (unsigned int **)((char *)&a8 + 4));
          Status = v23;
          if ( v23 )
          {
    ...
    else
    {
      ...
      if ( !v24 )
        goto LABEL_19;
      LODWORD(a7) = 0;
      status_1 = nmFilterDoInternalRequest(OID_DOT11_CURRENT_OPERATION_MODE, DeviceExtension, 0, (__int64 *)v37, 8u, 0, a7, &v36);
      Status = status_1;
      if ( status_1 )
      {
        DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_ERROR_LEVEL, "NmDot11QueryPhyId: status %x\n", status_1);
...
void __fastcall NmIoReadCancelRoutine(_DEVICE_OBJECT *DeviceObject, _IRP *Irp)
{
  ...
  if ( TestFilterModuleSignature(DeviceObject) )
  {
    ...
    else
    {
      ...
      *((_DWORD *)v8 + 6) &= 0xFFFFFFFD;
      KeReleaseSpinLock(&FsContext->SpinLock, FsContext->irql);
      NmDerefCaptureBuffer((PVOID)v8);
    }
    NmDerefCaptureBuffer((PVOID)v8);
  }
  else
  ...
  if ( LODWORD(CurrentStackLocation->FileObject->FsContext2) == 18175 )
  {
    if ( CurrentStackLocation->Parameters.Read.Length >= 0x32 )
    {
      ...
      if ( MdlAddress )
      {
        ...
        while ( MdlAddress );
        v13 = (char *)ExAllocatePoolWithTag(NonPagedPool, 0x108ui64, 'bcMN');// 有一个大结构?
        v14 = v13;
        if ( !v13 )
        {
LABEL_23:
        ...
        memset(v13, 0, 0x108u);
        *((_QWORD *)v14 + 4) = DeviceExtension;
        *(_WORD *)v14 = 264;
        *((_QWORD *)v14 + 5) = 0i64;
        v15 = (_LIST_ENTRY *)(v14 + 72);
        *((_WORD *)v14 + 1) = 18175;
        ...
        *((_DWORD *)v14 + 24) = CurrentStackLocation->Parameters.Read.Length;
        if ( !_InterlockedExchange((volatile __int32 *)&FsContext->field_B8, 1)
          && !_InterlockedCompareExchange64((volatile signed __int64 *)&FsContext->WorkItem, 0i64, 0i64) )
        {
          _InterlockedAdd(&FsContext->gap18, 1u);
          v17 = IoAllocateWorkItem((PDEVICE_OBJECT)FsContext->FilterDeviceExtension->DeviceObject);
          if ( v17 )
          {
            _InterlockedCompareExchange64((volatile signed __int64 *)&FsContext->WorkItem, (signed __int64)v17, 0i64);
        ...
        IoReleaseCancelSpinLock(Irp->CancelIrql);
        LOBYTE(FsContext->irql) = KeAcquireSpinLockRaiseToDpc(&FsContext->SpinLock);
        _InterlockedAdd(&FsContext->gap18, 1u);
        *((_DWORD *)v14 + 6) |= 2u;
        *((_QWORD *)v14 + 8) = FsContext;
        *((_QWORD *)v14 + 7) = &FsContext->SpinLock;
        v18 = FsContext->list0.Blink;
        v15->Flink = &FsContext->list0;
        *((_QWORD *)v14 + 10) = v18;
        v18->Flink = v15;
        FsContext->list0.Blink = v15;
        v19 = *((_QWORD *)v14 + 8);
        if ( *(_DWORD *)(v19 + 104) )
          --*(_DWORD *)(v19 + 104);
        KeReleaseSpinLock(&FsContext->SpinLock, FsContext->irql);
...
__int64 __fastcall NetmonGetTimeStamp(FilterDeviceExtension *FilterModuleContext, __int64 *a2)
{
  ...
  *a2 = 0i64;
  ...
  v5 = *(__int64 *)((char *)&FilterModuleContext->field_24C + 4);
  v10 = (unsigned int)v4;
  ...
  if ( !_bittest((const signed __int32 *)&NetBufferLists->Flags, 0xFu) )
  {
    ...
    if ( v12 )
    {
      ...
      *(_QWORD *)a1 = TimeStamp;
      while ( 1 )
      {
        v15 = FilterModuleContext->qword3B0;
        v32 = 2;
        v33 = 32;
        v34 = 0;
        v35 = 0i64;
        ...
        *(_BYTE *)(FilterModuleContext->qword3B0 + 136i64) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v15 + 128));
        v16 = FilterModuleContext->qword3B0;
        v17 = *(_DWORD *)(v16 + 168);
        ...
        if ( !v19 )
          break;
        v20 = FilterModuleContext->qword3B0;
        v21 = *(_DWORD *)(v19 + 4);
        HIDWORD(v36) = *(_DWORD *)(v19 + 20);
        v22 = *(_BYTE *)(v19 + 24);
        LODWORD(v35) = v21;
        v37[0] = v22;
        v23 = 0;
    ...
    *(_QWORD *)a1 = TimeStamp;
    if ( NetBufferList )
    {
      do
      {
        ...
        *(_DWORD *)&v25[8] = 0;
        v25[12] = 0;
        v13 = FilterModuleContext->qword3B0;
        v23[0] = 2;
        strcpy(&v23[1], " ");
        if ( v13 )
        {
...
LABEL_31:
    ...
    else
    {
      ...
      if ( NmCopyNetBufferToCaptureBuffer((__int64)FilterModuleContext, v20, a6, (char *)(v11 - 8), v7, a1, (void *)a2, a3a) )
        ++*(_QWORD *)(v11 + 272);
    }
    NmDerefUserProc((FileContext *)(v11 - 8));
    if ( (a7 & 1) == 1 )
...
NTSTATUS __fastcall NmCopyNetBufferToCaptureBuffer(__int64 a4, unsigned int edx0, void *a2, char *r9_0, unsigned int a3, void *a2a, void *a7, unsigned int a3a)
{
  ...
  while ( 1 )
  {
    ...
    for ( i = *(char **)v11; ; i = *(char **)i )
    {
      ...
      v15 = i - 72;
      if ( (*(i - 48) & 1) == 0 && (v15[24] & 2) != 0 )
        break;
    }
    _InterlockedAdd((volatile signed __int32 *)v15 + 22, 1u);
    v16 = *((_DWORD *)v15 + 24);
    if ( v16 - (unsigned __int64)*((unsigned int *)v15 + 23) >= v9 )
      break;
    *((_DWORD *)v15 + 6) |= 1u;
  ...
  if ( v12 )
    ...
    v15[48] = KeAcquireSpinLockRaiseToDpc(v18);
  v19 = *((_DWORD *)v15 + 23);
  SpinLock_3 = (KSPIN_LOCK *)(v15 + 40);
  *((_DWORD *)v15 + 23) = v19 + v9;
  if ( v12 )
    KeReleaseSpinLockFromDpcLevel(SpinLock_3);
  else
    KeReleaseSpinLock(SpinLock_3, v15[48]);
  SpinLock_4 = (KSPIN_LOCK *)(r9_0 + 32);
  if ( v12 )
    KeReleaseSpinLockFromDpcLevel(SpinLock_4);
  else
    KeReleaseSpinLock(SpinLock_4, r9_0[40]);
  v22 = (_MDL *)*((_QWORD *)v15 + 1);
  MdlAddress[0] = v22;
  if ( v22 )
  {
    if ( (v22->MdlFlags & 5) != 0 )
...
LABEL_37:
      ...
      if ( !NmCopyBufferToMdlWrapper(MdlAddress, a2a, 0x18u, &a3) && a3 == 24 )
      {
        ...
        if ( !a3a || !NmCopyBufferToMdlWrapper(MdlAddress, a7, a3a, &a3) && a3 == v27 )
        {
          ...
          {
            _InterlockedAdd((volatile signed __int32 *)v15 + 30, 1u);
            NmDerefCaptureBuffer(v15);
            return 0;
          }
        }
  ...
  if ( v12 )
    ...
    v15[48] = KeAcquireSpinLockRaiseToDpc(SpinLock_5);
  *((_DWORD *)v15 + 23) = v16;
  SpinLock_6 = (KSPIN_LOCK *)(v15 + 40);
  if ( v12 )
    KeReleaseSpinLockFromDpcLevel(SpinLock_6);
  else
    KeReleaseSpinLock(SpinLock_6, v15[48]);
  *(_DWORD *)(*((_QWORD *)v15 + 2) + 48i64) = STATUS_INSUFFICIENT_RESOURCES;
  ++*((_DWORD *)v15 + 31);
  NmDerefCaptureBuffer(v15);
  return STATUS_INSUFFICIENT_RESOURCES;
}
...
void __fastcall NmSyncTimerSystem(FilterDeviceExtension *Context)
{
  ...
  if ( Context )
  {
    ...
    _InterlockedExchange64((volatile __int64 *)((char *)&Context->field_24C + 4), PerformanceFrequency.QuadPart);
    _InterlockedExchange64((volatile __int64 *)((char *)&Context->field_244 + 4), v2.QuadPart);
    _InterlockedExchange((volatile __int32 *)&Context->field_254 + 1, 0);
  }
}
...
void __fastcall ScanLongTimersDpc(struct _KDPC *Dpc, FilterDeviceExtension *DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  ...
  {
    v11 = _InterlockedIncrement((volatile signed __int32 *)&DeferredContext->field_254 + 1);
...
void __fastcall NmInitializeTimerSystem(FilterDeviceExtension *DeviceExtension)
{
  ...
  if ( !LOBYTE(DeviceExtension->field_2E0) )
  {
    ...
    LOBYTE(DeviceExtension->field_2E0) = 1;
  }
}
...
BOOL __fastcall NmStopTimerSystem(FilterDeviceExtension *DeviceExtension)
{
  ...
  b = TRUE;
  if ( DeviceExtension->field_2E0 )
  {
    DeviceExtension->field_2E0 = 0;
...
__int64 __fastcall NmCreateUserProc(FilterDeviceExtension *FilterDeviceExtension, FileContext **ctx1, FileContext **ctx2)
{
  ...
  v9 = (_QWORD *)FilterDeviceExtension->field_2F0;
...
LABEL_8:
    LOBYTE(FsContext->irql) = irql_2;
    while ( next != (FileContext *)&FsContext->list0 )
    {
      v9 = (volatile signed __int32 *)&next[-1].field_110;
      next = *(FileContext **)&next->word0;
      if ( (v9[6] & 1) == 0 && (v9[6] & 2) != 0 )
      {
        _InterlockedAdd(v9 + 22, 1u);
        if ( (v9[6] & 2) != 0 )
        {
          ...
          *((_DWORD *)v9 + 6) &= 0xFFFFFFFD;
        }
        *(_DWORD *)(*((_QWORD *)v9 + 2) + 48i64) = 0xC0000008;
        *(_QWORD *)(*((_QWORD *)v9 + 2) + 56i64) = 0i64;
        KeReleaseSpinLock(&FsContext->SpinLock, FsContext->irql);
...
void __fastcall NmUploadCaptureBuffer(volatile FilterDeviceExtension *DeviceExtension, FileContext *FsContext)
{
  ...
  if ( b )
  {
    ...
    if ( is_dpc )
      ...
      LOBYTE(FsContext->irql) = KeAcquireSpinLockRaiseToDpc(SpinLock_2);
    v10 = &FsContext->list0;
    ...
    while ( v11 != v10 && b )
    {
      ...
      else
      {
        if ( !*((_DWORD *)v12 + 30) )
        {
          if ( v12[8][7].Flink == &v12[8][7] )
            break;
          b = 0;
        }
        *((_DWORD *)v12 + 6) = v13 & 0xFFFFFFFD | 1;
        v11 = v11->Flink;
        ...
        NmDerefCaptureBuffer(v12);
        SpinLock_4 = &FsContext->SpinLock;
        if ( is_dpc )
          KeAcquireSpinLockAtDpcLevel(SpinLock_4);
        else
          LOBYTE(FsContext->irql) = KeAcquireSpinLockRaiseToDpc(SpinLock_4);
        v10 = &FsContext->list0;
      }
    }
    ...
    default:
      switch ( MiniportMediaType )
      {
        case NdisMediumWan:
          ...
          LOBYTE(FilterModuleContext->gap224) = 1;
        ...
        case NdisMediumNative802_11:
          ...
          if ( v4 )
          {
            ...
            {
              *(_DWORD *)(FilterModuleContext->qword3B0 + 148i64) = HIDWORD(v10);
              if ( _bittest((const signed __int32 *)&v10 + 1, 0x1Fu) )
                *(_DWORD *)(FilterModuleContext->qword3B0 + 144i64) = 1;
            }
            if ( !nmOid_Query(OID_DOT11_CURRENT_OPERATION_MODE, FilterModuleContext, &v11, 8u) )
              pNmDot11StoreOpMode(FilterModuleContext->qword3B0, SHIDWORD(v11));
            nmOid_Query(65806, FilterModuleContext, &FilterModuleContext->filter, 4u);
          }
          if ( nmOid_Query(16843009, FilterModuleContext, &FilterModuleContext->field_368, 0x20u) )
            _InterlockedAdd(&g_InternalRequestFailedCount, 1u);
          if ( !nmOid_Query(16843010, FilterModuleContext, &FilterModuleContext->field_388, 0x20u) )
          {
LABEL_38:
            LODWORD(FilterModuleContext->field_234) = 14;
            FilterModuleContext->field_22C = 0x600000006i64;
...
LABEL_40:
      HIDWORD(FilterModuleContext->gap224) = 0;
      goto LABEL_41;
  }
  LOBYTE(FilterModuleContext->gap224) = 0;
...
LABEL_42:
  ...
  else if ( LOBYTE(FilterModuleContext->gap224) != 1 )
  {

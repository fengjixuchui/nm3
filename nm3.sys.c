...
NDIS_STATUS __stdcall NetmonSetOptions(NDIS_HANDLE NdisDriverHandle, NDIS_HANDLE DriverContext);
...
NTSTATUS __fastcall NmGetFilterSize(PVOID SystemBuffer, _DWORD *NumberOfBytes, _DWORD *a3, PVOID Buffer);
NTSTATUS __fastcall NmUnserializeCaptureFilter(FileContext *FsContext, PVOID SystemBuffer, unsigned int InputBufferLength, PVOID Buffer);
...
NTSTATUS __stdcall NmFilterRootDeviceIoClose(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS __stdcall NmFilterRootDeviceIoCreate(PDEVICE_OBJECT DeviceObject, PIRP Irp);
...
void __stdcall NetmonUnload(struct _DRIVER_OBJECT *DriverObject);
...
NDIS_STATUS __stdcall NetmonFilterAttach(NDIS_HANDLE NdisFilterHandle, NDIS_HANDLE FilterDriverContext, PNDIS_FILTER_ATTACH_PARAMETERS AttachParameters);
void __stdcall NetmonFilterDetach(FilterDeviceExtension *FilterModuleContext);
...
void __stdcall NetmonSendNetBufferLists(FilterDeviceExtension *FilterModuleContext, PNET_BUFFER_LIST NetBufferList, NDIS_PORT_NUMBER PortNumber, ULONG SendFlags);
  ...
  else
  {
    *(_QWORD *)&OidRequesta[1].DATA.METHOD_INFORMATION.MethodId = OidRequest;
    ...
    if ( OidRequest_2->RequestType == NdisRequestSetInformation
      && OidRequest_2->DATA.QUERY_INFORMATION.Oid == OID_GEN_CURRENT_PACKET_FILTER
      && OidRequest_2->DATA.QUERY_INFORMATION.InformationBufferLength == 4 )
    {
      ...
      FilterModuleContext->Irql = irql;
      FilterModuleContext->filter = *(_DWORD *)InformationBuffer;
      if ( !b )
        *(_DWORD *)InformationBuffer = Information | FilterModuleContext->field_1EC;
...
NDIS_STATUS __fastcall NetmonFilterSetModuleOptions(FilterDeviceExtension *FilterModuleContext)
{
  ...
  void (__stdcall *SendNetBufferLists)(FilterDeviceExtension *, PNET_BUFFER_LIST, NDIS_PORT_NUMBER, ULONG); // [rsp+28h] [rbp-30h]
  ...
  if ( FilterModuleContext->field_20E )
  {
...
LABEL_7:
  ...
  OidRequest.RequestId = (PVOID)'RFMN';
...
NDIS_STATUS __fastcall NmRegisterFilter(PDRIVER_OBJECT DriverObject)
{
  ...
  FilterDriverCharacteristics.AttachHandler = NetmonFilterAttach;
  ...
  FilterDriverCharacteristics.SetOptionsHandler = NetmonSetOptions;
  ...
  DriverObject->DriverUnload = NetmonUnload;
...
void __fastcall NmDestroyCaptureBuffer(CaptureBuffer *CaptureBuffer)
{
  ...
  else
  {
    ...
    *(_QWORD *)&v10[1] = 0i64;
    ...
    CaptureBuffer->irp->IoStatus.Information = CaptureBuffer->Information;
    if ( MappedSystemVa )
...
NTSTATUS __fastcall NmGetFilterSize(PVOID SystemBuffer, _DWORD *NumberOfBytes, _DWORD *a3, PVOID Buffer)
{
  ...
  *a3 = 0;
  ...
  if ( v6 )
  {
    ...
    {
      v8 += 12;
      *NumberOfBytes += 8 * *((_DWORD *)v11 + 2) + 20;
      if ( v8 >= v7 )
...
NTSTATUS __fastcall NmUnserializeCaptureFilter(FileContext *FsContext, PVOID SystemBuffer, unsigned int InputBufferLength, PVOID Buffer)
{
  ...
  unsigned int InputBufferLen; // [rsp+A0h] [rbp+18h]
  _QWORD *irp; // [rsp+A8h] [rbp+20h]

  irp = Buffer;
  InputBufferLen = InputBufferLength;
  v31 = 0;
  InputBufLen = InputBufferLength;
  NtStatus = NDIS_STATUS_INVALID_PARAMETER;

  if ( SystemBuffer && Buffer && *((_DWORD *)SystemBuffer + 7) == InputBufferLength )
  {
    result = NmGetFilterSize(SystemBuffer, &NumberOfBytes, &v31, SystemBuffer);
    if ( result )
      return result;
    ...
    v13 = 36;
    memmove(temp, SystemBuffer, 0x24u);
    v14 = v12[8];
    v15 = (const __m128i *)((char *)SystemBuffer + 0x24);
    v16 = 8 * v14 + 36;
    v17 = (_DWORD *)((char *)v12 + v16);

    if ( InputBufLen <= 0x24 || v16 >= (unsigned int)NumberOfBytes )
    ...
    if ( v14 )
    {
      while ( !NtStatus )
      {
        ...
        *v18 = (__int64)v17;
        v16 += 8 * v17[2] + 12;
        v17 = (_DWORD *)((char *)v12 + v16);
        if ( v13 >= InputBufLen || v16 >= (unsigned int)NumberOfBytes )
        {
          NtStatus = STATUS_DATA_OVERRUN;
          goto LABEL_29;
        }
        ...
        if ( *(_DWORD *)(v20 + 8) )
        {
          while ( 1 )
          {
            ...
            *(_QWORD *)(v23 + 16) = v17;
            ...
            v16 += v26;
            v13 += v26;
            InputBufLen = InputBufferLen;
            v15 = (const __m128i *)((char *)v34 + v27);
            v34 = (const __m128i *)((char *)v34 + v27);
            v17 = (_DWORD *)((char *)v12 + v16);
            if ( v13 > InputBufferLen || v16 > (unsigned int)NumberOfBytes )
            {
              v18 = v35;
              break;
            }
...
NTSTATUS __fastcall NmAddCaptureFilter(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( Status || InputBufferLength != *((_DWORD *)SystemBuffer + 7) )
  {
    NtStatus = Status;
    if ( !Status )
      NtStatus = NDIS_STATUS_INVALID_PARAMETER;
  ...
  else
  {
    ...
    if ( v11 && SLOBYTE(FsContext->field_40) >= 0 )
    {
      ...
      do
      {
        v11 = *((_DWORD *)SystemBuffer + 5) == LODWORD(list2[1].Flink);
        list2 = list2->Flink;
        if ( v11 )
...
LABEL_10:
        KeReleaseSpinLock(&FsContext->SpinLock, irql);
        NtStatus = NmUnserializeCaptureFilter(FsContext, Irp->AssociatedIrp.SystemBuffer, InputBufferLength, &Buffer);
        FsContext->irql = KeAcquireSpinLockRaiseToDpc(&FsContext->SpinLock);
        if ( NtStatus )
        {
        ...
        {
          list3 = (_LIST_ENTRY *)((char *)Buffer + 4);
          *(_QWORD *)((char *)Buffer + 12) = (char *)Buffer + 4;
          list3->Flink = list3;
...
NTSTATUS __fastcall NmCreateDot11Filter(NDIS_HANDLE NdisHandle, PNDIS_FILTER_ATTACH_PARAMETERS AttachParameter, Dot11Filter **Dot11Filter)
{
  ...
  if ( v7 < (unsigned __int64)(v7 + 8) + 184 )
  {
    ...
    Dot11Filter_3->tag = MiniportMediaSpecificAttributes->tag;
    ...
    {
      length = 0i64;
      j = &Dot11Filter_3->struc468;
      do
      {
        v14 = *(_DWORD *)((char *)&MiniportMediaSpecificAttributes->list.Blink->Flink + length + 4);
        if ( v14 == 4 )
        {
        ...
        p_1 = (struc468 *)NdisAllocateMemoryWithTagPriority(NdisHandle, 0x468u, 't3mN', LowPoolPriority);// 又是个结构？
        if ( p_1 )
        {
          *j = p_1;
          p_1->field_14 = i;
          ...
          p_1->oid = oid;
          p_1->size = 0x468;
          memmove(p_1->byte444, (char *)MiniportMediaSpecificAttributes->list.Blink + length, 0x444u);
        }
...
__int64 __fastcall NmInitializeGlobals(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
  KEY_VALUE_FULL_INFORMATION *KeyValueInfor; // rbx
  NTSTATUS NtStatus; // eax
  ...
  if ( !ZwOpenKey(&KeyHandle, KEY_READ, &ObjectAttributes) )
  {
    ...
    {
      KeyValueInfor = (KEY_VALUE_FULL_INFORMATION *)ExAllocatePool(NonPagedPool, Length);
      if ( KeyValueInfor )
      {
        if ( !ZwQueryValueKey(KeyHandle, &DestinationString, KeyValueFullInformation, KeyValueInfor, Length, &Length) )
        {
          GroupAce = (GroupAce *)ExAllocatePoolWithTag(NonPagedPool, KeyValueInfor->DataLength + 12i64, 'gamn');
          g_GroupAce = GroupAce;
          if ( GroupAce )
          {                                     // GroupAce肯定是一个结构。
            GroupAce->char0 = NULL;
            GroupAce->byte1 = NULL;
            DataLength = LOWORD(KeyValueInfor->DataLength) + 12;
            GroupAce->dword4 = 0x120089;
            GroupAce->DataLength = DataLength;
            memmove(&GroupAce->DataOffset, (char *)KeyValueInfor + KeyValueInfor->DataOffset, KeyValueInfor->DataLength);

            ExFreePoolWithTag(KeyValueInfor, 0);
            KeyValueInfor = NULL;
            Length = 24;
            ...
            if ( Status == NDIS_STATUS_BUFFER_OVERFLOW || Status == (unsigned int)STATUS_BUFFER_TOO_SMALL )
            {
              ...
              if ( KeyValueInfor )
              {
                if ( !ZwQueryValueKey(KeyHandle, &DestinationString, KeyValueFullInformation, KeyValueInfor, Length, &Length) && KeyValueInfor->DataLength )
                {
                  AttachUpperLayers = g_AttachUpperLayers;
                  if ( *(ULONG *)((char *)&KeyValueInfor->TitleIndex + KeyValueInfor->DataOffset) )
                    AttachUpperLayers = *(ULONG *)((char *)&KeyValueInfor->TitleIndex + KeyValueInfor->DataOffset);
            ...
            {
              if ( !ZwQueryValueKey(KeyHandle, &DestinationString, KeyValueFullInformation, KeyValueInfor, Length, &Length)
                && KeyValueInfor->DataLength == 4
                && KeyValueInfor->DataOffset )
              {
                g_TimeSyncIntervalCount = *(ULONG *)((char *)&KeyValueInfor->TitleIndex + KeyValueInfor->DataOffset);
              }
              ExFreePoolWithTag(KeyValueInfor, 0);
              KeyValueInfor = NULL;
            }
            ...
            if ( KeyValueInfor )
            {
              if ( !ZwQueryValueKey(KeyHandle, &DestinationString, KeyValueFullInformation, KeyValueInfor, Length, &Length)
                ...
                && KeyValueInfor->DataOffset )
              {
                g_FilterScanTimerInterval = *(ULONG *)((char *)&KeyValueInfor->TitleIndex + KeyValueInfor->DataOffset);
              }
              ExFreePoolWithTag(KeyValueInfor, 0);
              KeyValueInfor = NULL;
            }
            ...
            if ( KeyValueInfor )
            {
              if ( !ZwQueryValueKey(KeyHandle, &DestinationString, KeyValueFullInformation, KeyValueInfor, Length, &Length)
                ...
                && KeyValueInfor->DataOffset )
              {
                g_OlpFilterConditionMaxCount = *(ULONG *)((char *)&KeyValueInfor->TitleIndex + KeyValueInfor->DataOffset);
              }
              ExFreePoolWithTag(KeyValueInfor, 0);
              KeyValueInfor = NULL;
            }
...
NDIS_STATUS __stdcall NetmonFilterAttach(NDIS_HANDLE NdisFilterHandle, NDIS_HANDLE FilterDriverContext, PNDIS_FILTER_ATTACH_PARAMETERS AttachParameters)
{
  ...
  if ( !g_AttachUpperLayers && Length != 0x30 )
  {
    if ( g_NmDebug )
    ...
    && RtlCompareMemory(Dst, BaseMiniportName->Buffer, 36ui64) == 36 )
  {
    ...
    if ( NtStatus )
    {
      ...
      b = TRUE;
      *(_WORD *)&DeferredContext->gap20C = Length;
    }
    else
    {
      FilterModuleContext = DeferredContext;
...
NTSTATUS __fastcall NmCreateFilterModule(NDIS_HANDLE NdisFilterHandle, PNDIS_FILTER_ATTACH_PARAMETERS AttachParameters, FilterDeviceExtension **DeferredContext)
{
  ...
  if ( BaseMiniportName )
  {
    ...
    buffer = NdisAllocateMemoryWithTagPriority(NdisFilterHandle, Length, 't3mN', LowPoolPriority);
    p = buffer;
    v27.i64[1] = (__int64)buffer;
    if ( buffer )
    {
      v27.i16[1] = BaseMiniport.Length;
      memmove(buffer, BaseMiniport.Buffer, BaseMiniport.Length);
...
LABEL_28:
  ...
  if ( AttachParameters->MiniportMediaType == NdisMediumNative802_11
    && AttachParameters->FilterModuleGuidName->Buffer[(unsigned __int64)(AttachParameters->FilterModuleGuidName->Length - 1) >> 1] == 0x30 )
  {
  ...
  if ( NtStatus >= 0 )
  {
    ...
    *(_QWORD *)&DeviceExtension->field_150 = &DeviceExtension->char3B8;
    ...
    *(_WORD *)&DeviceExtension->char3C8 = Length_2;
    ...
    BaseMiniportName_1 = (void *)(DeviceExtension->qword3D0 + *(unsigned __int16 *)&DeviceExtension->char3C8);
    DeviceExtension->BaseMiniportName = BaseMiniportName_1;
    Length_3 = AttachParameters->BaseMiniportName->Length;
    DeviceExtension->word3DA = Length_3;
    *(_WORD *)&DeviceExtension->char3D8 = Length_3;
    memmove(BaseMiniportName_1, AttachParameters->BaseMiniportName->Buffer, Length_3);
    ...
    *(__m128i *)&v23 = _mm_loadu_si128(&v27);
    DeviceExtension->field_20E = 1;
    DeviceExtension->field_210 = 1;
    DeviceExtension->dword214 = 0;
    DeviceExtension->SymbolicLink = SymbolicLinkName_1;
    *(_OWORD *)&DeviceExtension->m128i130 = *(_OWORD *)&v23;
...
void __fastcall NmDestroyFilterModule(FilterDeviceExtension *DeviceExtension)
{
  ...
  void *v6; // rcx
  PWSTR v7; // rcx
  Dot11Filter *Dot11Parameters; // rcx
  ...
  Dot11Parameters = DeviceExtension->Dot11;
  if ( Dot11Parameters )
    NmDeleteDot11Parameters(Dot11Parameters);
  ...
  if ( IoControlCode > 0x2100A0 )
  {
    ...
    if ( v27 )
    {
      ...
      if ( v28 )
      {
        ...
        if ( !v29 )
        {
          if ( OutputBufferLength == 4 && SystemBuffer )
          {
            Status = 0;
            *(_DWORD *)SystemBuffer = DeviceExtension->State;
    ...
    if ( v13 )
    {
      ...
      if ( v14 )
      {
        ...
        if ( v15 )
        {
          ...
          if ( !v16 || v16 == 4 )
          {
            if ( InputBufferLength_1 == 4 && SystemBuffer )
            {
              status_2 = NmDot11SetChannel(DeviceExtension, *(_DWORD *)SystemBuffer);
              goto LABEL_46;
            }
            goto LABEL_62;
          }
...
LABEL_47:
  ...
  if ( InputBufferLength_1 == 4 && SystemBuffer )
  {
    status_2 = NmDot11SetPhyId(DeviceExtension, *(_DWORD *)SystemBuffer);
LABEL_46:
    Status = status_2;
    if ( status_2 )
      goto LABEL_62;
...
NTSTATUS __fastcall NmFilterModuleIoCleanup(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  {
    FileObject = CurrentStackLocation->FileObject;
    if ( LODWORD(FileObject->FsContext2) == 0x46FF && (FsContext = (FileContext *)FileObject->FsContext, NmVerifyUserProcObject(FsContext) >= 0) )
    {
...
LABEL_11:
  ...
  Irp->IoStatus.Status = NDIS_STATUS_PENDING;
  Irp->IoStatus.Information = 0i64;
  if ( !MasterIrp || MasterIrp[5] != 12 )
    goto LABEL_10;
  for ( i = 0; i < 12u; ++i )
  {
    if ( MasterIrp[i + 8] != aNmuserprocea[i] )
      break;
  }
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)v37 = 0i64;
        ...
        if ( v20 && (unsigned int)v24 < v20->dwordA4 )
          v23 = *(_DWORD *)(*(&v20->struc468 + v24) + 24i64);
        HIDWORD(v35) = v23;
        if ( (v21 & 4) == 0 )
          goto LABEL_18;
...
NTSTATUS __fastcall NmCopyNetBufferToCaptureBuffer(FilterDeviceExtension *FilterModuleContext, unsigned int edx0, void *a2, char *r9_0, unsigned int a3, void *a2a, void *a7, unsigned int a3a)
{
  ...
  while ( 1 )
  {
    ...
    v16 = Capture->gap60;
    if ( v16 - (unsigned __int64)(unsigned int)Capture->Information >= v9 )
      break;
    Capture->field_18 |= 1u;
  ...
  v19 = Capture->Information;
  SpinLock_3 = &Capture->SpinLock;
  Capture->Information = v19 + v9;
  if ( v12 )
    KeReleaseSpinLockFromDpcLevel(SpinLock_3);
  else
...
LABEL_16:
  ...
  {
    CurrentStackLocation->FileObject->FsContext = FsContext;
    CurrentStackLocation->FileObject->FsContext2 = (PVOID)0x46FF;
...
__int64 __fastcall NmCreateUserProc(FilterDeviceExtension *FilterDeviceExtension, FileContext **ctx1, FileContext **ctx2)
{
  ...
  v9 = FilterDeviceExtension->list2.Blink;
  v8 = (_LIST_ENTRY *)((char *)v8 + 8);
  v8->Blink = v9;
  v8->Flink = &FilterDeviceExtension->list2;
  v9->Flink = v8;
  FilterDeviceExtension->list2.Blink = v8;
...
NTSTATUS __fastcall NmVerifyUserProcObject(FileContext *FsContext)
{
  ...
  NtStatus = STATUS_SUCCESS;
  if ( FsContext && FsContext->word0 == 0x158 && FsContext->word2 == 0x46FF )
  {
    FsContext->irql = KeAcquireSpinLockRaiseToDpc(&FsContext->SpinLock);
    ...
    if ( CurrentStackLocation->Parameters.DeviceIoControl.InputBufferLength >= 0x20 )
    {
      ...
      if ( *(_WORD *)SystemBuffer == 0x20 )
      {
        ...
        else
        {
          ...
          {
            FsContext->MdlAddress = (PMDL)*((_QWORD *)SystemBuffer + 1);
            FsContext->IrpCount = *((_DWORD *)SystemBuffer + 5);
            IrpCount = *((_DWORD *)SystemBuffer + 6);

            if ( IrpCount < DeviceExtension->field_234 )
              IrpCount = DeviceExtension->field_234;

            FsContext->field_40 = v12 | 0x80;
            FsContext->field_94 = IrpCount;
...
void __fastcall NmUserProcGetStats(PDEVICE_OBJECT DeviceObject, FileContext *Context)
{
  ...
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_CO_RCV_PDUS_OK, &a3, 4u) )
    Context->field_12C = a3;
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_DIRECTED_BYTES_RCV, &v7, 8u) )
    Context->field_138 = v7;
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_RCV_ERROR, &a3, 4u) )
    Context->field_14C = a3;
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_RCV_CRC_ERROR, &a3, 4u) )
    Context->field_130 = a3;
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_CO_RCV_PDUS_NO_BUFFER, &a3, 4u) )
    Context->field_140 = a3;
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_MULTICAST_FRAMES_RCV, &a3, 4u) )
    Context->field_144 = a3;
  if ( !NmGetGlobalStat(DeviceExtension, OID_GEN_BROADCAST_FRAMES_RCV, &a3, 4u) )
...
void __fastcall NmInitializeMinipInfo(NDIS_MEDIUM MiniportMediaType, FilterDeviceExtension *FilterModuleContext)
{
  ...
  switch ( MiniportMediaType )
  {
    ...
    case NdisMedium802_5:
      FilterModuleContext->field_228 = 2;
      FilterModuleContext->field_22C = 8;
      FilterModuleContext->field_234 = 32;
      break;
    case NdisMediumFddi:
      FilterModuleContext->field_228 = 1;
      FilterModuleContext->field_22C = 7;
      FilterModuleContext->field_234 = 13;
      break;
    default:
      switch ( MiniportMediaType )
      {
        case NdisMediumWan:
          ...
          if ( nmOid_Query(OID_WAN_CURRENT_ADDRESS, FilterModuleContext, &FilterModuleContext->field_388, 0x20u) )
            _InterlockedAdd(&g_InternalRequestFailedCount, 1u);
          FilterModuleContext->field_234 = 14;
          FilterModuleContext->gap224 = 1;
          FilterModuleContext->field_22C = 6;
          FilterModuleContext->field_230 = 6;
          goto LABEL_40;
        ...
        case NdisMediumNative802_11:
          v4 = FilterModuleContext->field_18C == 9;
          a3[0] = 0i64;
          a3[1] = 0i64;
          v10 = 0i64;
          if ( v4 )
          {
            ...
            nmOid_Query(OID_GEN_CURRENT_PACKET_FILTER, FilterModuleContext, (__int64 *)&FilterModuleContext->filter, 4u);
          }
          if ( nmOid_Query(OID_802_3_PERMANENT_ADDRESS, FilterModuleContext, &FilterModuleContext->field_368, 0x20u) )
            _InterlockedAdd(&g_InternalRequestFailedCount, 1u);
          if ( !nmOid_Query(OID_802_3_CURRENT_ADDRESS, FilterModuleContext, &FilterModuleContext->field_388, 0x20u) )
...
LABEL_37:
      ...
      FilterModuleContext->field_22C = 0;
      FilterModuleContext->field_230 = 0;
      FilterModuleContext->field_234 = 0;
LABEL_39:
      FilterModuleContext->gap224 = 0;
LABEL_40:
      FilterModuleContext->field_228 = 0;
      goto LABEL_41;
  }
  ...
  FilterModuleContext->field_230 = 6;
LABEL_41:
  FilterModuleContext->field_238 = 0;
  FilterModuleContext->field_239 = 0;
LABEL_42:
  if ( FilterModuleContext->field_18C == 9 )
  {
    if ( MiniportMediaType == NdisMediumNative802_11 )
      FilterModuleContext->field_238 = 1;
  }
  else if ( FilterModuleContext->gap224 != 1 )
  {
    ...
    if ( g_NmDebug )
    {
      DbgPrintEx(DPFLTR_IHVNETWORK_ID, DPFLTR_ERROR_LEVEL, "NmQueryPacketFilter: status %x, filter %d\n", status, FilterModuleContext->filter);
      NmDebug = g_NmDebug;
    }

    if ( FilterModuleContext->filter < 0x10u )
    {
      FilterModuleContext->filter = 11;
      if ( NmDebug )
      {
        LODWORD(v8) = 11;
...
failure:
  ...
  MajorFunctions[IRP_MJ_CLEANUP] = NmFilterRootDeviceIoCreate;
  MajorFunctions[IRP_MJ_CLOSE] = NmFilterRootDeviceIoClose;
  MajorFunctions[IRP_MJ_DEVICE_CONTROL] = NmFilterRootDeviceIoControl;
  MajorFunctions[0] = NmFilterRootDeviceIoCreate;
